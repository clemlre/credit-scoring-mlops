...
AGUIAR = dict(
    ...
    colsample_bytree=0.9497036, reg_alpha=0.041545473, reg_lambda=0.0735294,
    min_split_gain=0.0222415, min_child_weight=39.3259775,
    random_state=42, n_jobs=-1, verbose=-1,
)
lgb_gbdt = LGBMClassifier(**AGUIAR, subsample=0.8715623)
...
# data_sample_strategy remplace boosting_type='goss' (déprécié)
lgb_goss = LGBMClassifier(**AGUIAR, data_sample_strategy="goss")
